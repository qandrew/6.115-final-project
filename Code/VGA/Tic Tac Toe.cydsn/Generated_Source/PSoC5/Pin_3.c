...
void Pin_3_SetDriveMode(uint8 mode)
{
	...
	CyPins_SetPinDriveMode(Pin_3_2, mode);
	CyPins_SetPinDriveMode(Pin_3_3, mode);
	CyPins_SetPinDriveMode(Pin_3_4, mode);
	CyPins_SetPinDriveMode(Pin_3_5, mode);
	CyPins_SetPinDriveMode(Pin_3_6, mode);
	CyPins_SetPinDriveMode(Pin_3_7, mode);
}
...
/* If interrupt is connected for this Pins component */ 
    ...
    *******************************************************************************/
    void Pin_3_SetInterruptMode(uint16 position, uint16 mode)
    {
		...
		if((position & Pin_3_1_INTR) != 0u) 
		{ 
			 Pin_3_1_INTTYPE_REG = (uint8)mode; 
		} 
		if((position & Pin_3_2_INTR) != 0u) 
		{ 
			 Pin_3_2_INTTYPE_REG = (uint8)mode; 
		} 
		if((position & Pin_3_3_INTR) != 0u) 
		{ 
			 Pin_3_3_INTTYPE_REG = (uint8)mode; 
		} 
		if((position & Pin_3_4_INTR) != 0u) 
		{ 
			 Pin_3_4_INTTYPE_REG = (uint8)mode; 
		} 
		if((position & Pin_3_5_INTR) != 0u) 
		{ 
			 Pin_3_5_INTTYPE_REG = (uint8)mode; 
		} 
		if((position & Pin_3_6_INTR) != 0u) 
		{ 
			 Pin_3_6_INTTYPE_REG = (uint8)mode; 
		} 
		if((position & Pin_3_7_INTR) != 0u) 
		{ 
			 Pin_3_7_INTTYPE_REG = (uint8)mode; 
		}
    }
