...
void Pin3_SetDriveMode(uint8 mode)
{
	...
	CyPins_SetPinDriveMode(Pin3_1, mode);
	CyPins_SetPinDriveMode(Pin3_2, mode);
	CyPins_SetPinDriveMode(Pin3_3, mode);
	CyPins_SetPinDriveMode(Pin3_4, mode);
	CyPins_SetPinDriveMode(Pin3_5, mode);
	CyPins_SetPinDriveMode(Pin3_6, mode);
	CyPins_SetPinDriveMode(Pin3_7, mode);
}
...
/* If interrupt is connected for this Pins component */ 
    ...
    *******************************************************************************/
    void Pin3_SetInterruptMode(uint16 position, uint16 mode)
    {
		...
		if((position & Pin3_1_INTR) != 0u) 
		{ 
			 Pin3_1_INTTYPE_REG = (uint8)mode; 
		} 
		if((position & Pin3_2_INTR) != 0u) 
		{ 
			 Pin3_2_INTTYPE_REG = (uint8)mode; 
		} 
		if((position & Pin3_3_INTR) != 0u) 
		{ 
			 Pin3_3_INTTYPE_REG = (uint8)mode; 
		} 
		if((position & Pin3_4_INTR) != 0u) 
		{ 
			 Pin3_4_INTTYPE_REG = (uint8)mode; 
		} 
		if((position & Pin3_5_INTR) != 0u) 
		{ 
			 Pin3_5_INTTYPE_REG = (uint8)mode; 
		} 
		if((position & Pin3_6_INTR) != 0u) 
		{ 
			 Pin3_6_INTTYPE_REG = (uint8)mode; 
		} 
		if((position & Pin3_7_INTR) != 0u) 
		{ 
			 Pin3_7_INTTYPE_REG = (uint8)mode; 
		}
    }
