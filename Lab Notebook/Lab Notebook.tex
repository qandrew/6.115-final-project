...
\\ I will use port a of my 8255 on the microcontroller to send databits to Port 3 of the PSoC. I configured my port 3 to be input and {\em high impedance digital} with a low drive. You can see my code at \texttt{main.c} at my current commit to see the code I wrote. 
