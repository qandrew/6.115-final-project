...
module top ;
	...
	wire [0:0] tmpOE__PinNoise_net;
	wire [0:0] tmpIO_0__PinNoise_net;
	wire [0:0] tmpINTERRUPT_0__PinNoise_net;
	electrical [0:0] tmpSIOVREF__PinNoise_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .input_buffer_sel(2'b00))
		PinNoise
		 (.oe(tmpOE__PinNoise_net),
		  .y({1'b0}),
		  .fb({Net_534}),
		  .io({tmpIO_0__PinNoise_net[0:0]}),
		  .siovref(tmpSIOVREF__PinNoise_net),
		  .interrupt({tmpINTERRUPT_0__PinNoise_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PinNoise_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


	cy_clock_v1_0
		#(.id("b73be249-9608-4191-a456-e80fc4537bb0"),
