...
\begin{center}\includegraphics[width = 70mm]{Pics/5-8b.jpg}\end{center}

The schematic I will be using is the following. The input to the 1070 5-pin capacitave sensor are my buttons for my input is the board that can be seen above. While the inputs are fed into P1.0 to P1.4, I also use a 74LS30 to NAND all of the signals to trigger the external interrupt at P3.4. 
\begin{center}
\includegraphics[width = 70mm]{Pics/5-8a.jpg}
\includegraphics[width = 80mm]{Pics/5-10b.jpg}
\end{center}
...
\\ The convention between PSoC and 8051 will be defined as follows. My \texttt{cap\_input.hex} file will assist me in doing this.  
\begin{center}
\begin{tabular}{ |c|c|c| } 
 \hline
Databus Value & Corresponding Action \\ 
\hline
\#31h & Level Swap \\ 
\#32h & Move Right \\ 
\#33h & Move Left \\ 
...
Goals I have for today / {\bf done} if task completed
\begin{tight_itemize}
\item Play 3D tic tac toe using my touch panel board  {\bf done}
\end{tight_itemize}

\subsection{ Play 3D tic tac toe using my touch panel board }
I was able to get the touch panel to work! And I can now play 3D tic tac toe against my AI; although I have a few bugs in my code, and I am not using the 8051. At all. Hmm. 
\begin{center}\includegraphics[width = 80mm]{Pics/5-9a.jpg}\end{center}
I solved the PSoC Problem in the new \texttt{cap\_input.asm} code. The problem was that P1 reads too quickly. See my May 9th commit. 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
Goals I have for today / {\bf done} if task completed
\begin{tight_itemize}
\item Finish the project! {\bf done}
\item Write up hardware and software schematics
\end{tight_itemize}

\subsection{Finish the project!}
I can confidently say that on May 10th, 2016, I am done with my 6.115 final project! The 3D Tic Tac Toe game can be played using a capacitave-based touch sensor gamepad, and I have programmed an AI to counter the human's moves. The output of the game is displayed on the VGA.
\\ One problem I ran into was that when I was using a flashing red light to display the location of the current position, the VGA display transmission was consuming too much computing power of the PSoC so I couldn't read an input from the keypad. I considered using an interrupt; however interrupting a VGA transmission is a bad idea so I decided against it. I instead changed the aesthetics of the cursor so we can still play the game and know where we placed keys. 

\subsection{Final Hardware Schematics}
Below is the hardware schematic of my R31JP board
\begin{center}\includegraphics[width = 120mm]{Pics/5-10a.jpg}\end{center}

Below is the hardware schematic of my PSoC.
\begin{center}\includegraphics[width = 80mm]{Pics/5-10c.jpg}\end{center}

\appendix
\section{Acknowledgements}
I would like to give my heartfelt gratitude towards Prof. Leeb and all of the TAs and LAs that have made 6.115 my favorite and most enjoyable class at MIT so far. 

\section{Code}
The remaining code can be found online at \href{https://github.com/qandrew/6.115-final-project}{https://github.com/qandrew/6.115-final-project}. 
