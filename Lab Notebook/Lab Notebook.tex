...
The schematic I will be using is the following. The input to the 1070 5-pin capacitave sensor are my buttons for my input is the board that can be seen above. 
\begin{center}\includegraphics[width = 80mm]{Pics/5-8a.jpg}\end{center}
